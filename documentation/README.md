...
Thank you to everyone I worked with or learned from during my time at ECAL / University of Art and Design Lausanne, as well as in the research project *Automated Photography*. ECAL is an incredible melting pot for photography, and this project is deeply inspired by the observations and insights I gained while studying and working there. Thank you Milo and the whole team and students.

Also, thank you also to everyone at the Master Transdisciplinarity Studies in the Arts program at ZHdK / Zürich University of the Arts. Without the countless discussions, the great support and open framework provided for developing this project, it would not be what it has become.  
...
A simplified version of this documentation for print is available here: There is no changelog in the printversion, only the most recent version is available.
