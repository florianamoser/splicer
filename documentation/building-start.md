...
- Basic Software fluency: familiarity with installing Linux and Windows, and basic G-code/CNC concepts.
- Basic Mechanical skills: the ability to handle assembly, calibration, and maintenance.
