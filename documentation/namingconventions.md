...
- Equipped with **three screens**, arranged top left to bottom right:
  - **Camera Image Preview**
  - **Streaming Preview**
  - **CNC Motion Control**
- At the top, two **Overhead Extrusions** extend forward:
  - Serve as structural supports for mounting **lights**, **diffusers**, and **grip equipment**.
